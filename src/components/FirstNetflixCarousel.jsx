...
class FirstNetflixCarousel extends Component {
  state = {
    movies: [],
  }

  componentDidMount() {
    this.FunzioneMovies1()
  }

  FunzioneMovies1 = () => {
    fetch("https://www.omdbapi.com/?s=avengers&apikey=6ba8a037")
      .then((response) => {
        if (response.ok) {
  ...
  render() {
    ...
    }) //l'ultima immagine è rotta
    return (
      <Container fluid className="px-4 py-2 bg-dark">
        <h4 className="text-white mb-3 pt-2 fs-5">The Avengers</h4>
...
export default FirstNetflixCarousel
